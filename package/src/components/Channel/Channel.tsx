...
import { useCreateChannelCapabilitiesContext } from './hooks/useCreateChannelCapabilitiesContext';
import {
  ChannelCapabilitiesContextValue,
  ChannelCapabilitiesProvider,
...
> = Pick<ChannelContextValue<At, Ch, Co, Ev, Me, Re, Us>, 'channel'> &
  ...
  > & {
    ...
    overrideChannelCapabilities?: ChannelCapabilitiesContextValue;
...
>(
  ...
  const channelCapabilitiesContext = useCreateChannelCapabilitiesContext({
    channel,
    overrideCapabilities: overrideChannelCapabilities,
  });
  ...
  return (
    ...
    >
      <ChannelProvider<At, Ch, Co, Ev, Me, Re, Us> value={channelContext}>
        <ChannelCapabilitiesProvider value={channelCapabilitiesContext}>
