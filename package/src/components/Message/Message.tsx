...
import { useChannelCapabilitiesContext } from '../../contexts/channelCapabilitiesContext/ChannelCapabilitiesContext';
import {
  ChannelContextValue,
  useChannelContext,
...
>(
  ...
  const channelCapabilities = useChannelCapabilitiesContext();
  ...
  const showMessageOverlay = async (
    ...
    setData({
      ...
      groupStyles,
      handleReaction: channelCapabilities.sendReaction ? handleReaction : undefined,
